...
- **Private YouTube link:** *(fill in at submission time)*  
  - Link: https://youtu.be/y-EC3WnDPeI
...
|---|---|---|---|
| 1 | Send Hello message on the same running machine | Server correctly receives the modified message and echoes it back | Video shows bidirectional message exchange |
